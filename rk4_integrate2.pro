...
function RK_4_step, loc, dt, ionizelife
  ...
  ; RK4 Step 2
    ...
    ;RK_4_acceleration(x2[0,*], x2[1,*], x2[2,*], t - .5*dt, v_radial)        
  ...
  ; RK4 Step 3
    ...
    ;RK_4_acceleration(x3[0,*], x3[1,*], x3[2,*], t - .5*dt, v_radial)
...
pro RK4_integrate2, loc, bounce, ionizelife, atoms_per_packet, timestep
  COMMON Model_shared, Body, Ephemeris_time, Seed, Directory, Particle_data, Line_data, Debug
