...
Speed_distribution = 'MBF_150K'                           ; Set the speed distribution the particles will be released with
;Speed_distribution = 'Johnson_2002'                      ; Set the speed distribution the particles will be released with
...
Number_of_particles    = long(2^10-1)                      ; Number of packets of atoms in the simulation, do not exceed 32766 = 2^15-1
;Number_of_particles    = long(10000) 
if keyword_set(Time_range_this_run) then Time_range=Time_range_this_run else $
;Time_range             = [0.,5.]   
Time_range             = [0.,.5]                        ; When to start and stop releasing particles from the planet [End, Begin] days ago e.g., [0.0, 0.5]                     
...
Upward_flux_at_exobase = 1.e25                            ; Upward Flux accross the exobase in particles per second, integrated over 2 pi steradians, or for an intantaneous event, e.g. a meteor's total vapourization
...
FOV                    = 1200.                               ; ARCSECONDS to a side. Field of View of output images (RA & Dec SKY COORDINATES)

;FOV                    = 28.                               ; ARCSECONDS to a side. Field of View of output images (RA & Dec SKY COORDINATES)
